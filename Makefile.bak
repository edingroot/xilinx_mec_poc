...
LDFALGSU96+=-lboost_system -lboost_thread -lpthread `pkg-config --cflags opencv` `pkg-config --libs opencv` -lopencv_core -lopencv_video -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs -lopencv_highgui -ldpclassification  -lglog  

mec_http_server_general:${SRC}/mec_http_server/main.o\
...
image_classifier_dpu.o: ${SRC}/mec_http_server/image_classifier_dpu.cpp ${SRC}/mec_http_server/image_classifier.hpp\
    ${CXX} ${CXXFLAGS}  -o ${OUTPUT}/mec_http_server/$@   $^  ${LDFALGSU96}
...
mec_http_server_dpu:${SRC}/mec_http_server/main.o\
	...
	@${CXX} ${CXXFLAGS} -D DPU -o ${OUTPUT}/mec_http_server/$@   $^  ${LDFALGSU96}
...
mec_http_server_caff:${SRC}/mec_http_server/main.o\
	...
	@${CXX} ${CXXFLAGS} -D CAFF  -o ${OUTPUT}/mec_http_server/$@   $^  ${LDFLAGS}
